...
//                    textview12.startAnimation(shake);
    ...
    private void fillNumbersInTextViews (int level) {


        Log.d("version1","Filling numbers in textView  ");

        int timerCount = level*600;
        for (int i = 0; i < level; i++) {
            ...
            if (randomtext == 0) {
                ...
                textview1.setBackground(getResources().getDrawable(R.drawable.round_view));
                timer = new TimerTask() {
                    @Override
                    public void run() {
                ...
                _timer.schedule(timer, (int) (timerCount));
            }
            if (randomtext == 1) {
                textview2.setText(String.valueOf((long) (randomnumber)));
                textview2.setBackground(getResources().getDrawable(R.drawable.round_view));
                timer = new TimerTask() {
                    @Override
                    public void run() {
                        runOnUiThread(new Runnable() {
            ...
            if (randomtext == 2) {
                ...
                textview3.setBackground(getResources().getDrawable(R.drawable.round_view));
                timer = new TimerTask() {
                    @Override
                    public void run() {
                        runOnUiThread(new Runnable() {
            ...
            if (randomtext == 3) {
                ...
                textview4.setBackground(getResources().getDrawable(R.drawable.round_view));
                timer = new TimerTask() {
                    @Override
                    public void run() {
                        runOnUiThread(new Runnable() {
            ...
            if (randomtext == 4) {
                ...
                textview5.setBackground(getResources().getDrawable(R.drawable.round_view));
                timer = new TimerTask() {
                    @Override
                    public void run() {
                        runOnUiThread(new Runnable() {
            ...
            if (randomtext == 5) {
                ...
                textview6.setBackground(getResources().getDrawable(R.drawable.round_view));
                timer = new TimerTask() {
                    @Override
                    public void run() {
                        runOnUiThread(new Runnable() {
            ...
            if (randomtext == 6) {
                ...
                textview7.setBackground(getResources().getDrawable(R.drawable.round_view));
                timer = new TimerTask() {
                    @Override
                    public void run() {
                        runOnUiThread(new Runnable() {
            ...
            if (randomtext == 7) {
                ...
                textview8.setBackground(getResources().getDrawable(R.drawable.round_view));
                timer = new TimerTask() {
                    @Override
                    public void run() {
                        runOnUiThread(new Runnable() {
            ...
            if (randomtext == 8) {
                ...
                textview9.setBackground(getResources().getDrawable(R.drawable.round_view));
                timer = new TimerTask() {
                    @Override
                    public void run() {
                        runOnUiThread(new Runnable() {
            ...
            if (randomtext == 9) {
                ...
                textview10.setBackground(getResources().getDrawable(R.drawable.round_view));
                timer = new TimerTask() {
                    @Override
                    public void run() {
                        runOnUiThread(new Runnable() {
            ...
            if (randomtext == 10) {
                ...
                textview11.setBackground(getResources().getDrawable(R.drawable.round_view));
                timer = new TimerTask() {
                    @Override
                    public void run() {
                        runOnUiThread(new Runnable() {
            ...
            if (randomtext == 11) {
                ...
                textview12.setBackground(getResources().getDrawable(R.drawable.round_view));
                timer = new TimerTask() {
                    @Override
                    public void run() {
                        runOnUiThread(new Runnable() {
